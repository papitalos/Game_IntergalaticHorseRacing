...
namespace HorseProject
{
    public static class CicloDiario
    {
        ...
        public static void TocarMusica(int audio)
        {
            ...
            if (audio == 1)
            {
                player = new System.Media.SoundPlayer(@"C:\Users\guilh\source\repos\papitalos\IntergalaticHorseRacing\HorseProject\Menu.wav");
                player.Play();
            }
            else if (audio == 2)
            {
                player = new System.Media.SoundPlayer(@"C:\Users\guilh\source\repos\papitalos\IntergalaticHorseRacing\HorseProject\Som_de_trompetas.wav");
                player.Play();
            }
            else if (audio == 3)
            {
                player = new System.Media.SoundPlayer(@"C:\Users\guilh\source\repos\papitalos\IntergalaticHorseRacing\HorseProject\Corrida.wav");
                player.Play();
            }
            currentAudio = audio;
        }
